...
#define PANTECH_REPAIR_USERDATA_START         (PANTECH_ROOTING_CHECK_START+PANTECH_ROOTING_CHECK_LENGTH)
...
#else
#define BACKUP_SECTOR_LENGTH            (PANTECH_ROOTING_CHECK_START+PANTECH_ROOTING_CHECK_LENGTH-BACKUP_SECTOR_START)
#endif
