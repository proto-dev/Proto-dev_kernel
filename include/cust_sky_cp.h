...
/* Qualcomm OEM Hook 占쏙옙占쏙옙占쏙옙 占싱울옙占쏙옙 확占쏙옙.  ( NV access, SIM access etc..) */
#define FEATURE_SKY_CP_QCRILHOOK_INTERFACE // FEATURE_TODO [Qcril_sky_rapi.c 占쌩곤옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占십울옙]


/* Qualcomm Feature [FEATURE_QCRIL_UIM_QMI] 占쏙옙占쏙옙 */
#define FEATURE_SKY_CP_SUPPORT_FEATURE_QCRIL_UIM_QMI
#ifdef FEATURE_SKY_CP_SUPPORT_FEATURE_QCRIL_UIM_QMI
/* qcril 占쏙옙占쏙옙 mmgsdi 占쏙옙 gsdi function 占쏙옙占쏙옙占쏙옙 RPC callback 占쏙옙 占십울옙占쏙옙. */
#define FEATURE_SKY_CP_GSDI_RPC_CALLBACK_SUPPORT
#endif/* FEATURE_SKY_CP_SUPPORT_FEATURE_QCRIL_UIM_QMI */

#ifdef FEATURE_TODO
/* QCRIL RPC 占십깍옙화 占쌩곤옙占쏙옙占쏙옙. 
   System VOB占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쌔쇽옙 target feature占쏙옙 qcril_qmi.mk 占쏙옙占쏙옙 占쏙옙占쏙옙占쌔듸옙 */
...
*/
#define FEATURE_SKY_CP_OEM_RAPI_CM_EVENT_SUPPORT // FEATURE_TODO [Qcril_cm_svcmgr.h占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙]
...
// FEATURE_TODO [
// qcril_other_usim 占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 QMI占쏙옙 占쏙옙占쏙옙 占십울옙占쏙옙.
...
/* RPC占쏙옙 占쏙옙占쌔쇽옙 占쏙옙占쏙옙커占실듸옙 처占쏙옙 ( 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 커占실듸옙 처占쏙옙 ) */
#define FEATURE_SKY_CP_PROCESS_CMD_WITH_RPC // FEATURE_TODO [RPC 占쏙옙占쏙옙 占쏙옙占쏙옙커占실듸옙 처占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙]
...
/** init.rc에 추가해야 (init_모델명.rc)
** init.rc는 \LINUX\android\system\core\rootdir */
...
/* Airplane mode 진입시 network mode menu 진입이 순간적으로 진입이 가능해지는 문제 발생
  ...
  존재 하지 않음 */
#define FEATURE_SKY_CP_AIRPLANE_MODE_CHECK_BOX_CONTROL // FEATURE_TODO [AirplaneModeEnabler.java占쏙옙 占쏙옙占쏙옙 占쌜억옙 占싹뤄옙占쏙옙 占쏙옙, 占쏙옙占쏙옙占쌔억옙占쏙옙]
...
#define FEATURE_SKY_CP_RSSI_REPORT_TIMING_GAP_FIX // FEATURE_TODO [StatusBarPolicy.java 占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙]
...
#define FEATURE_SKY_CP_FACTORY_AIRPLANE_MODE_I // FEATURE_TODO [占십울옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占실단듸옙]
...
// [EF34K_ICS] 30155 패치에 DTMF 수정사항 반영.
//             P,W 기능 수정.
#define FEATURE_SKY_CP_30155_PATCH_FOR_DTMF_ERROR
...
#define FEATURE_SKY_CP_LOCAL_DB     // qcril_qmi_security.c 占쏙옙 ME Perso. 占쌜억옙占쏙옙占식울옙 占쌩곤옙占쏙옙 占쏙옙.
...
#define FEATURE_SKY_USIM_CARD_TYPE    //FEATURE_TODO : keyguardstatusviewmanager.java 占쏙옙 占쌩곤옙占쌔억옙占쏙옙.
...
/* qualcomm OEM RAPI占싱울옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 ( FEATURE_SKY_RPC_OEM_RAPI_NEW_INTERFACE 占쏙옙 占쏙옙占쏙옙화)
   !!! kernel/arch/arm/mach-msm/oem_rapi_client.c 占쏙옙占쏙옙 占쌥듸옙占쏙옙 Feature 占쏙옙占쏙옙占쏙옙占쌍억옙占쏙옙 占쏙옙. 
   vendor占쏙옙 vendor\qcom\proprietary\modem-apis\msm7627_surf\api\libs\remote_apis\oem_rapi\inc\oem_rapi.h, buffer length 占쏙옙占쏙옙 
   vendor\qcom\proprietary\modem-apis\msm7627_surf\api\libs\remote_apis\oem_rapi\src\oem_rapi_clnt.c, out length 占쏙옙占쏙옙 占쏙옙占쏙옙 */
#define FEATURE_SKY_CP_OEM_RAPI_USING


/* SIM card type占쏙옙 확占쏙옙占쏙옙 占쏙옙 占쌍댐옙 I/F 占쏙옙占쏙옙. ( 占쏙옙占쏙옙占쏙옙 占썰구占쏙옙占쏙옙 占쌥울옙占쏙옙 占쏙옙占쏙옙. ) */
...
/* FEATURE_SKY_CP_RPC_XDR_NV_ACCESS feature占쏙옙 占쏙옙占쏙옙화占쏙옙 占쏙옙占쏙옙.
   XDR占쏙옙 占쏙옙占쏙옙占쌍댐옙 占쏙옙占쏙옙占쏙옙 占쌩곤옙 */
...
/* KT 占쏙옙占쏙옙占쌘울옙 GPS Test menu 占쌜억옙 (##759477#) */
...
/* KT GPS - H/W Cno Test menu 占쌜억옙    
   Timeout, CNo 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 */
#define FEATURE_SKY_CP_GPS_CNO

/* KT GPS 占쏙옙占쏙옙 NV Item RW 占쏙옙占쏙옙 占쌩곤옙 占쌜억옙 */
...
/* GPS Test 占쏙옙占쏙옙 (GPSLocationProvider.java) */
...
/* [EF40K] - FEATURE_SKY_CP_SUP_SVC_FOR_ANDROID占쏙옙 占십울옙占쏙옙 sups_info(CM_SUPS_EVENT)占쏙옙 CM RPC占쏙옙 占쏙옙占쌨받듸옙占쏙옙 占쏙옙*/
